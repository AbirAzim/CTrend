...
export class CampaignSeedService implements OnModuleInit {
  ...
  private readonly WC_RULES =
    ...
    'Before kickoff, you can also predict the exact score. Among eligible voters, exact-score predictors get first priority in the prize draw. Knockout matches are graded on the score after 90 minutes plus extra time — penalty shootouts do not count. If you recently won a campaign prize, you can only re-enter the draw for the next 4 matches when you predict the exact score.\n' +
  ...
  private readonly WC_RULES_BN =
    ...
    'কিক-অফের আগে আপনি সঠিক স্কোরও প্রেডিক্ট করতে পারেন। যোগ্য ভোটারদের মধ্যে সঠিক স্কোর প্রেডিক্ট করেছেন তাদের পুরস্কার ড্রতে অগ্রাধিকার পাবেন। নকআউট ম্যাচে স্কোর গণনা হয় ৯০ মিনিট ও এক্সট্রা টাইমের পর — পেনাল্টি শুটআউট গণনায় আসে না। সম্প্রতি ক্যাম্পেইন পুরস্কার জিতলে পরবর্তী ৪টি ম্যাচের ড্রতে শুধু সঠিক স্কোর প্রেডিক্ট করলেই অংশ নিতে পারবেন।\n' +
